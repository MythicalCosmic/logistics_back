...
from admins.views import user_views, role_views, facility_views, activity_views, analytics_views, state_views
...
urlpatterns = [
    ...
    # States
    path("states", state_views.list_states, name="admin_state_list"),
    path("states/<str:abbreviation>", state_views.state_detail, name="admin_state_detail"),
    path("states/<str:abbreviation>/analytics", state_views.state_analytics, name="admin_state_analytics"),
